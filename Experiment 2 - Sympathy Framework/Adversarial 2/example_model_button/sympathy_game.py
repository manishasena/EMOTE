...
if bench_mark == 0:
    ...
    def rgb_transform(rgb):
        ...
        for i in range(rgb_converted.shape[0]):
            ...
            if len(other_rf[0]) != 0:
                if len(rgb_converted.shape) == 3:
                    rgb_converted[i,other_rf[0][:],other_rf[1][:],other_rf[2][:]] = 0
                else:
                    rgb_converted[i,other_rf[0][:],other_rf[1][:],0] = 0

            
            if len(other_hf[0]) != 0:
                if len(rgb_converted.shape) == 3:
                    rgb_converted[i,other_hf[0][:],other_hf[1][:],other_hf[2][:]] = 0
                else:
                    rgb_converted[i,other_hf[0][:],other_hf[1][:],0] = 0
